...
export default function LandingPage({ navigation }) {
  ...
  const handleDownloadAPK = () => {
    Linking.openURL('https://tu-servidor.com/download/dec-app.apk');
  };
                ...
                <View style={styles.mockupContainer}>
                  <View style={styles.phoneMockup}>
                    <View style={styles.phoneScreen}>
                      ...
                      <MaterialCommunityIcons name="camera-iris" size={42} color={C.primary} />
                      <Text style={styles.mockupText}>Detección en vivo</Text>
                      <View style={styles.mockupBadge}><Text style={styles.mockupBadgeText}>YOLOv11</Text></View>
                    </View>
                  </View>
        ...
        <View style={styles.statsContainer}>
          ...
          <View style={styles.mainContainer}>
            <View style={styles.statsGrid}>
              <StatCard end={98} suffix="%" label="Precisión" icon="trending-up" />
...
const BenefitCard = ({ icon, title, desc }) => {
  // Usamos MaterialCommunityIcons para 'leaf', Feather para el resto
...
const styles = StyleSheet.create({
  ...
  heroImageSide: { flex: 1, alignItems: 'center' },
  mockupContainer: { position: 'relative' },
  phoneMockup: { width: 280, height: 560, backgroundColor: '#1f2937', borderRadius: 48, padding: 12, borderWidth: 2, borderColor: 'rgba(255,255,255,0.3)' },
  phoneScreen: { flex: 1, backgroundColor: '#f0fdf4', borderRadius: 36, alignItems: 'center', justifyContent: 'center', gap: 12 },
  cameraNotch: { width: 120, height: 28, backgroundColor: '#000', borderRadius: 20, position: 'absolute', top: 8, alignSelf: 'center' },
  mockupText: { fontSize: 18, fontWeight: '700', color: C.text },
  mockupBadge: { backgroundColor: C.accent, paddingHorizontal: 12, paddingVertical: 4, borderRadius: 20 },
  mockupBadgeText: { color: '#fff', fontWeight: 'bold' },
  floatingChip: { 
    position: 'absolute', bottom: -20, right: -30, backgroundColor: '#fff', paddingVertical: 8, paddingHorizontal: 16, borderRadius: 40, flexDirection: 'row', alignItems: 'center', gap: 8,
    ...Platform.select({
      web: { boxShadow: '0 6px 12px rgba(0,0,0,0.1)' },
      default: { shadowColor: '#000', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.1, shadowRadius: 12, elevation: 8 }
    })
  },
  floatingText: { fontWeight: '600', color: C.primaryDark },
  ...
  cardContent: { padding: 28, backgroundColor: 'rgba(255,255,255,0.85)', backdropFilter: 'blur(4px)' },
  ...
  statCard: { flex: 1, minWidth: 150, alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.12)', borderRadius: 32, padding: 24, backdropFilter: 'blur(8px)' },
