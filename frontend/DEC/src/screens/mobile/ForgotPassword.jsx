...
const isValidEmail = (value) => /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(value); // validacion del email
...
const handleRecover = async () => {
    ...
    try {
        await axios.post(`${API_URL}/forgot-password`, { email: email.trim() }); // Colocar la url correcta 
      ...
      {/* -- Tarjeta -- */}
        ...
        >
            ...
            {loading ? (
                ...
                <Text style={styles.buttonText}>Recupera Contraseña</Text>
                </>
            )}
            </LinearGradient>
        </TouchableOpacity>
